...
<a href="https://en.wikipedia.org/wiki/Maginot_Line" target="_blank">
    <img src="{{ site.baseurl }}/assets/images/maginot.jpg" alt="Maginot Line" title="Maginot Line" style="width:100%; display: block;" />
</a>
...
I'm not suggesting not to automate deploys, just that they're not the bottleneck to earlier feedback.
